...
def TrEESR(ref_file_path,output_path,long_read_alignment_file_path,sr_region_selection,filtering,threads,READ_LEN=150,READ_JUNC_MIN_MAP_LEN=0):
    ...
    if long_read_alignment_file_path is not None:
        ...
        long_read_gene_matrix_dict = generate_all_feature_matrix_long_read(gene_isoforms_dict,LR_gene_regions_dict,long_read_gene_regions_read_count,long_read_gene_regions_read_length,LR_genes_regions_len_dict,num_LRs,total_long_read_length,False)
    else:
    ...
    generate_TrEESR_output(output_path,short_read_gene_matrix_dict,long_read_gene_matrix_dict,info_dict_list,same_structure_isoform_dict,removed_gene_isoform_dict)
