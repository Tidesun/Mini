...
def TransELS(ref_file_path,short_read_alignment_file_path,long_read_alignment_file_path,output_path,region_expression_calculation_method,alpha,beta,P,threads=1,delta_s_thres_length=0,delta_s_thres_num_exons=0,threshold=0,READ_LEN=150,READ_JUNC_MIN_MAP_LEN=0):
